...
public class JdbiSolutionRepoRepository implements SolutionRepoRepository {
    ...
    @Override
    public Optional<SolutionRepo> find(String taskId, String userId, Language language) {
    ...
    @Override
    public void save(String taskId, String userId, Language language, String repo, String webhookSecret) {
        jdbi.withHandle(
